...
OK, that's better. Now that we have a model, let's move to the next steps.
...
To determine whether the beta-binomial model predicts well the expected line level parasitism success, we can re-do the predictions, this time including aphid and parasitoid random effects:
